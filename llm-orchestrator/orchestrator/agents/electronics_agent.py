...
class ElectronicsAgent(BaseAgent):
    ...
    def _route_from_response(self, state: ElectronicsState) -> str:
        ...
        # 2. Response has substantial content (>200 chars)
        # 3. Query mentions saving or is a project-related query
        should_save = False
        ...
        if project_plan_action == "create":
            ...
            # Substantial response - likely has content to save
            should_save = True
...
"""
                ...
                # Get LLM response
                llm = self._get_llm(temperature=0.3)  # Lower temperature for technical accuracy
